...
{#if $confirmPopupState}
  ...
  >
    <div
      class="w-full max-w-md overflow-hidden rounded-lg border-2 border-black bg-white animate-[scale-up_0.18s_ease-out]"
    ...
    >
      ...
      <div class="space-y-5 px-4 py-5">
        <p class="text-sm font-semibold leading-relaxed text-zinc-700">{$confirmPopupState.message}</p>
