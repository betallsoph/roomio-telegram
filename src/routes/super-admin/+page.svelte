		...
		<div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-5 sm:px-6">
			<div class="min-w-0">
				...
				<div class="mt-3 flex flex-wrap items-end gap-3">
					<h1 class="text-2xl leading-tight font-black sm:text-3xl">Quản trị Roomio</h1>
				...
				<div class="min-w-0">
					...
					{:else}
						<div class="overflow-x-auto border-2 border-black">
							<div
								class="grid min-w-[680px] grid-cols-[minmax(220px,1.4fr)_120px_100px_120px_120px] bg-zinc-50 px-4 py-3 text-xs font-black text-zinc-500"
							>
								<span>Chủ trọ</span>
								<span>Gói</span>
								<span>Phòng</span>
